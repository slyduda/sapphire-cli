let writeFile,getAllContentFiles,getContentMetaData;_b6a‍.x([["default",()=>_b6a‍.o]]);_b6a‍.w("./utils",[["writeFile",["writeFile"],function(v){writeFile=v}],["getAllContentFiles",["getAllContentFiles"],function(v){getAllContentFiles=v}],["getContentMetaData",["getContentMetaData"],function(v){getContentMetaData=v}]]);const fs = require('fs');
...
const mention = async () => {
    ...
    for (let i = 0; i < newFiles.length; i++) {
        ...
        writeFile(dir, JSON.stringify(WEBMENTION_DATA), function (err) {
            if (err) {
                _b6a‍.g.console.log(JSON.stringify(WEBMENTION_DATA))
                throw err
            };
        })
    }
