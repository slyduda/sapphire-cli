let glob;_7ae‍.x([["kebabCase",()=>kebabCase],["writeFile",()=>writeFile],["makeid",()=>makeid],["stringIsAValidUrlScheme",()=>stringIsAValidUrlScheme],["stringIsAValidUrl",()=>stringIsAValidUrl],["getAllContentFiles",()=>getAllContentFiles],["getContentMetaData",()=>getContentMetaData],["getLinksFromMarkdown",()=>getLinksFromMarkdown]]);_7ae‍.w("glob",[["default",["glob"],function(v){glob=v}]]);const { URL, parse } = require('url');
const fs = require('fs');
...
const writeFile = (pathname, contents, cb) => {
    ...
    fs.mkdir(path.resolve(__dirname, folderName), { recursive: true }, err => {
        ...
        _7ae‍.g.console.log(pathname, folderName)
